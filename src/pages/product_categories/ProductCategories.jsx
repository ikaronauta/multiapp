// src/pages/sections/ProductCategories.jsx
...
export default function ProductCategories() {
  ...
  const handleEdit = (row) => {
    ...
    navigate(`/admin/product_categories/edit/${row.original.uuid}`);
  }
  ...
  return (
    <>
      <Link
        to="/admin/product_categories/create"
      ...
      <>
        ...
        {showConfirm && (
          <ModalConfirmDelete
            titleConfirm="¿Eliminar Categoría?"
            messageConfirm1="Esta acción no se puede deshacer."
            messageConfirm2="Debe ingresar excatamente el nombre de la categoría"
